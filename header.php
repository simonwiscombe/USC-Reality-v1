...
<!--<![endif]-->
	<head>
		...
		<title><?php wp_title( '|', true, 'right' ); ?>Reality Ends Here</title>
	...
	<div class="top-bar">
		<div class="wrapper">
			<a href="<?php echo site_url(); ?>" title="Reality Home">
				<div id="reality-logo"><img src="<?php bloginfo('stylesheet_directory') ?>/images/RealityEndsHere.jpg" alt="USC Reality" height=55 width=55></div>
			</a>
 ...
 -->
			...
			<?php else : ?>
				...
				<?php else : ?>
					...
					<?php $headerImage[0] = get_bloginfo( 'stylesheet_directory' ) . '/images/reality-defaultHeader.jpg'; ?>
