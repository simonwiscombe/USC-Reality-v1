...
function reality_dashboard_gamemaster_functions_function() {

	global $bp, $reality; 
	
	
	if(isset( $_GET['reality_reset_user_points'] ) ) {
		
		reality_update_all_user_points();
		
		echo '<div class="message success">Recalculated user points!</div>';
		
	}
	
	?>

		<a class="button" href="?reality_reset_user_points=1">Recalculate User Points</a>
...
function reality_dashboard_widgets() {
	...
	wp_add_dashboard_widget('reality_dashboard_gamemaster_functions', 'Reality Game Master Functions', 'reality_dashboard_gamemaster_functions_function');
} 
