...
function the_deal_comments( $post_id = false ) {
	...
	<?php if ( bp_has_activities( 'scope=0&primary_id='.$post_id ) ) : ?>
	...
	<?php if ( ( is_user_logged_in() && bp_activity_can_comment() ) || bp_activity_get_comment_count() ) : ?>
		...
		<div class="activity-comments no-js deals-single">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form visible"<?php bp_activity_comment_form_nojs_display(); ?> style="display:block;" >
	...
	<?php else: ?>
		...
		<?php if ( current_user_can('administrator' ) ) : ?>
			<h6 style="color:black;">You are an admin!</h6>
		<?php else: ?>
			<h6 style="color:black;">The comments are currently closed.</h6>
		<?php endif; ?>
	<?php endif; ?>
